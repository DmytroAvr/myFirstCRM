...
import datetime
from ..oids.models import (OIDTypeChoices, OIDStatusChoices, SecLevelChoices, WorkRequestStatusChoices, WorkTypeChoices, 
    DocumentReviewResultChoices, AttestationRegistrationStatusChoices, add_working_days
)
from ..oids.models import (Unit, UnitGroup, OID, OIDStatusChange, TerritorialManagement, 
...
from ..oids.forms import ( TripForm, TripResultSendForm, DocumentProcessingMainForm, DocumentItemFormSet, DocumentForm, 
...
from ..oids.forms import TechnicalTaskCreateForm, TechnicalTaskProcessForm # Додаємо нові форми
from ..oids.models import TechnicalTask, DocumentReviewResultChoices, OID, Unit, Person # Додаємо моделі
