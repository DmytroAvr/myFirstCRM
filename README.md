...
Не працює кнопка "Видалити" у меню редагування статусів. виправ це. 
також додай можливість визначати / змінювати порядок статусів

також потрібна можливість видаляти / змінювати проєкти

внеси зміну до умови "приховувати виконані задачі" (задачі які потрапляють в статус "Виконано".
встановити умову: приховувати задачі які потрапили в статус "виконано"  о 8:05 наступного дня, за днем виконання. Приклад. виконав сьогодні о 17:10, завтра о 8:05 задача прихована і відображається лише у "виконані задачі"