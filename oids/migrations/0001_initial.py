    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('note', models.TextField(blank=True, null=True, verbose_name='Примітки')),
                ('status', models.CharField(choices=[('нова заявка', 'Нова заявка'), ('Заявка в роботі', 'Заявка в роботі'), ('Заявка виконана', 'Заявка виконана'), ('Заявка скасована', 'Заявка скасована')], default='нова заявка', max_length=30, verbose_name='Поточний стан заявки')),
                ('oids', models.ManyToManyField(to='oids.oid', verbose_name='Об’єкти інформаційної діяльності')),
                ('unit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='oids.unit', verbose_name='Військова частина')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('work_type', models.CharField(choices=[('Атестація', 'Атестація'), ('ІК', 'ІК')], default='ІК', max_length=20, verbose_name='Тип роботи')),
                ('status', models.CharField(choices=[('нова заявка', 'Нова заявка'), ('Заявка в роботі', 'Заявка в роботі'), ('Заявка виконана', 'Заявка виконана'), ('Заявка скасована', 'Заявка скасована')], default='нова заявка', max_length=30, verbose_name='Статус опрацювання ОІД')),
