    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachment', models.FileField(blank=True, null=True, upload_to='attestation_registrations_sent/', verbose_name='Скан-копія вихідного листа (опційно)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attestation_registration_sent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registered_documents', to='oids.attestationregistration', verbose_name='Відправлено на реєстрацію ДССЗЗІ (в складі листа)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachment', models.FileField(blank=True, null=True, upload_to='attestation_responses_received/', verbose_name='Скан-копія листа-відповіді (опційно)')),
                ('note', models.TextField(blank=True, null=True, verbose_name='Примітка до відповіді')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('attestation_registration_sent', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='response_received', to='oids.attestationregistration', verbose_name="Пов'язана відправка (вихідний лист)")),
                ('received_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='processed_attestation_responses', to='oids.person', verbose_name='Хто отримав/вніс відповідь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review_result', models.CharField(choices=[('працювати', 'Опрацювати'), ('очікує в папері', 'Очікує в папері'), ('погоджено', 'Погоджено'), ('на доопрацювання', 'На доопрацювання')], default='погоджено', max_length=30, verbose_name='Результат розгляду')),
                ('note', models.TextField(blank=True, null=True, verbose_name='Примітка')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата створення запису')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Дата останнього оновлення')),
