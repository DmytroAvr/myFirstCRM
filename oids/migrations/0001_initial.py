    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата внесення в систему')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('note', models.TextField(blank=True, null=True, verbose_name='Примітка')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата додання інформації')),
            ...
            options={
                ...
                'unique_together': {('oid', 'input_number')},
            },
        ),
    ]
