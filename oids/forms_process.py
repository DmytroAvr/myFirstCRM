...
class DeclarationProcessStartForm(forms.Form):
    ...
    serial_number = forms.CharField(label="s/n", required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
    inventory_number = forms.CharField(label="Інв. №", required=False, widget=forms.TextInput(attrs={'class': 'form-control'}))
